...
import "./RCashTokenInterfacesModified.sol";
 ...
 */
abstract contract RCashTokenModified is
    RCashTokenInterface,
    ExponentialNoError,
    TokenErrorReporter
{
    ...
    function borrowInternal(uint) internal pure {
        revert("Not allowed");
    }

    function repayBorrowInternal(uint) internal pure {
        revert("Not allowed");
    }

    function repayBorrowBehalfInternal(address, uint) internal pure {
        revert("Not allowed");
    }
