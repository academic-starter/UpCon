...
json.dump(dict(uninitialized_impls=uninitialized_impls,
          ...
          open(os.path.join("usccheck",
               "etherscan_proxy_implementation.statistics.json"), "w"),
          indent=4
          )

category_dir = "./usccheck/category/ethereum_mainnet/multi_non_zero_impl"
...
category_dir = "./usccheck/category/ethereum_mainnet/sole_non_zero_impl"
if not os.path.exists(category_dir):
    os.makedirs(category_dir)
...
category_dir = "./usccheck/category/ethereum_mainnet/uninitialized_impl"
if not os.path.exists(category_dir):
    os.makedirs(category_dir)
